        ...
        >
          ...
          <motion.div variants={fadeUp} className="flex flex-col gap-3 mt-4">
            <motion.button
              ...
              whileTap={tapScale}
              className="w-full py-4 rounded-xl border border-vault-green bg-vault-green/10 text-vault-green font-bold text-base cursor-pointer transition-colors hover:bg-vault-green hover:text-white"
            >
              Withdraw Funds
            </motion.button>
            <motion.button
