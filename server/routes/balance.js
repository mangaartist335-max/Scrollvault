...
function isSupportedWithdrawMethod(method) {
...
router.post('/withdraw', auth, async (req, res) => {
  try {
    ...
    try {
      ...
      try {
        errorDetails = paypalError.message ? JSON.parse(paypalError.message) : errorDetails;
      } catch {
        errorDetails = { message: paypalError.message || 'Unknown PayPal Error' };
      }
