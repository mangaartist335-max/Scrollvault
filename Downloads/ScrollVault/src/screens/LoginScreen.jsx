...
export default function LoginScreen() {
  ...
  const handleSocial = async (provider) => {
    // Social login buttons on auth screens are for quick signup/login.
    // For now, redirect to signup where they can create an account,
    // then connect social accounts from the dashboard.
    navigate('/signup');
  };
